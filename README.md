...
- **Founded**: 2018
- **Today (2026-05-01)**: 80 clinics across 6 states
- **Revenue**: ~$240M TTM
- **EBITDA margin**: ~17% blended
- **PE sponsor**: Larkspur Capital (2019, second institutional round 2023)
- **Phase**: Q3 2026 deliberate M&A pause to focus on integration debt
- **Knowledge map**: open `MOC.canvas` in Obsidian or the portal
- **Stakeholder map**: open `knowledge-base/stakeholders/MAP.canvas` in Obsidian
...
- **Clinical & care quality**: Dr Elena Vasquez (CMO)
- **Operations & ops cadence**: Marcus Kim (COO)
- **Data & systems**: Priya Shah (CIO)
- **People & culture**: Lisa Rodriguez (CPO)
- **M&A & corp dev**: Dr James Okwu (Head of M&A)
- **Finance & board**: Tom Brennan (CFO)
- **CEO**: Dr Sarah Okafor
